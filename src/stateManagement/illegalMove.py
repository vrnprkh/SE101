...
class LegalMoveProcessor:
    ...
    def isLegal(boardProcessor, move, piece):
        ...
        if piece == 7 or piece == 1:
            return (move in Pawn.pawnLegal(move[0], move[1], boardProcessor.boardState.formatBoardState()))

        if piece == 9 or piece == 3:
            return (move in Knight.knightLegal(move[0], move[1], boardProcessor.boardState.formatBoardState()))

        if piece == 4 or piece == 10:
            return (move in Bishop.bishopLegal(move[0], move[1], boardProcessor.boardState.formatBoardState()))

        if piece == 2 or piece == 8:
            return (move in Rook.rookLegal(move[0], move[1], boardProcessor.boardState.formatBoardState()))
        
        if piece == 5 or piece == 11:
            return (move in Queen.queenLegal(move[0], move[1], boardProcessor.boardState.formatBoardState()))

        if piece == 6 or piece == 12:
            return (move in King.kingLegal(move[0], move[1], boardProcessor.boardState.formatBoardState()))
